...
namespace CBriscola
{
	class carta {
		...
		public static void inizializza(UInt16 n, cartaHelperBriscola h ,IAssetLoader asset) {
		...
		public static void CaricaImmagini(UInt16 n, cartaHelperBriscola helper, IAssetLoader assets)
		{
			Stream asset;
